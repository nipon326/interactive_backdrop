...
3. **แก้ไฟล์ [`shared/config.js`](./shared/config.js)** ใส่ค่าทั้งหมดที่ได้จากข้อ 1–2 และตั้ง `CONTROL_PIN` เป็นรหัสที่ทีมงานจำง่าย
...
- ข้อความ "ฝากถึงน้องๆ" ไม่มีการ moderation (เหมือนปีที่แล้ว) ใช้เป็น source ของ word cloud ช่วงท้าย
- คำถามและข้อความทั้งหมดถูกเก็บถาวรใน Firestore (ไม่มีการลบอัตโนมัติ) ย้อนดูภายหลังได้ผ่าน Firebase Console
- เพิ่มสติกเกอร์ใหม่ได้โดยแก้ array `STICKERS` ใน [`join/join.js`](./join/join.js)
